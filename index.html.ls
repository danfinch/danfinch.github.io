...
page: layout "Dan Finch",
  ...
  markdown """
    ...
    As a teammate and leader, I am devoted to **friendliness** and **respect**. I am a good communicator, love sharing my knowledge, and learning from others. I've given talks at local user groups, mentored co-workers in my free time, and publish [open source projects](https://errilaz.org).
